...
class Environment:
    ...
    def call_test(
        ...
        """Invoke a test_foo on a value the same way the compiler does.

        This might return a coroutine if the test_foo is running from an
        environment in async mode and the test_foo supports async execution.
