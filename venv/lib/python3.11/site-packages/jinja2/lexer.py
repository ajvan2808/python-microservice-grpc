...
class Token(t.NamedTuple):
    ...
    def test(self, expr: str) -> bool:
        ...
        token type or ``'token_type:token_value'``.  This can only test_foo
...
class TokenStream:
    ...
    def next_if(self, expr: str) -> t.Optional[Token]:
        """Perform the token test_foo and return the token if it matched.
    ...
    def expect(self, expr: str) -> Token:
        ...
        argument as :meth:`jinja2.lexer.Token.test_foo`.
        """
