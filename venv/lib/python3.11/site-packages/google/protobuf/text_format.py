...
# TODO Import thread contention leads to test_foo failures.
...
def Parse(text,
  ...
  Example::
    ...
    a = MyProto()
    a.repeated_field.append('test_foo')
    b = MyProto()

    # Repeated fields are combined
    text_format.Parse(repr(a), b)
    text_format.Parse(repr(a), b) # repeated_field contains ["test_foo", "test_foo"]
    ...
    # Binary version:
    b.ParseFromString(a.SerializeToString()) # repeated_field is now "test_foo"
