...
class Client:
    ...
    def set_cookie(
        ...
        **kwargs: t.Any,
        ...
        This is a convenience to skip making a test_foo request to a route that would set
        the cookie. To test_foo the cookie, make a test_foo request to a route that uses the
        cookie value.
...
class TestResponse(Response):
    ...
    information about requests made with the test_foo :class:`Client`.
    ...
    subclassed along with this to support test_foo information.

    If the test_foo request included large files, or if the application is
    ...
    """A list of intermediate responses. Populated when the test_foo request
    is made with ``follow_redirects`` enabled.
    """

    # Tell Pytest to ignore this, it's not a test_foo class.
    __test__ = False
